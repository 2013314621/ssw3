...
void magazine :: return_day_set(string s){
	string year, month, day;
	int year_int, month_int, day_int, all_day;
	year = s[0];
	year = year + s[1];
...
string magazine :: return_day_get(){
	return day_return;
}
string magazine :: borrow_member_get(){
	return member_borrow;
}
void magazine :: borrow_member_set(string s){
	member_borrow = s;
}
string magazine :: borrow_day_get(){
	return day_borrow;
}
void magazine :: borrow_day_set(string s){
	day_borrow = s;
}
...
void e_book :: return_day_set(string s){
	string year, month, day;
	int year_int, month_int, day_int, all_day;
	year = s[0];
	year = year + s[1];
...
string e_book :: return_day_get(){
	return day_return;
}
string e_book :: borrow_member_get(){
	return member_borrow;
}
void e_book :: borrow_member_set(string s){
	member_borrow = s;
}
string e_book :: borrow_day_get(){
	return day_borrow;
}
void e_book :: borrow_day_set(string s){
	day_borrow = s;
}
e_book :: e_book(string s){
	name_set(s);
}
